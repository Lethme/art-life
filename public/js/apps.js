document.addEventListener("DOMContentLoaded", function () {
  (() => {
                      ...
                      if (
                        ...
                        [
                          ...
                          if (a) {
                            ...
                            t[
                              n ? (n < 2 ? "months" : "overlayMonths") : "days"
                            ] = a;
                          }
                        }),
                        f && f > 0 && f < 7)
          ...
          function scope(target, options, originalOptions) {
            ...
            function getClosestHandle(clickedPosition) {
              ...
              scope_Handles.forEach(function (handle, index) {
                ...
                var clickAtEdge =
                  100 === differenceWithThisHandle &&
                  100 === smallestDifference;
    ...
    (() => {
      ...
      function rangeInit(id, start, range, step, onUpdate) {
        const priceSlider = document.querySelector(`#${id}`);
        if (priceSlider) {
          priceSlider.getAttribute("data-from");
          priceSlider.getAttribute("data-to");
          nouislider.create(priceSlider, {
            start: [start.min, start.max],
            connect: true,
            tooltips: [
              wNumb({
                decimals: 0,
          ...
          priceSlider.noUiSlider.on("update", onUpdate);
        }
      }
      document.initRangedSlider = rangeInit;
      // rangeInit({
      //     min: 0,
      //     max: 1e5
      // }, {
      ...
      function getTrueOffsetParent(element) {
        if (
          ...
          "fixed" === getComputedStyle_getComputedStyle(element).position
        )
          return null;
      ...
      function getOffsetParent(element) {
        ...
        while (
          ...
          "static" === getComputedStyle_getComputedStyle(offsetParent).position
        )
      ...
      var variationPlacements = basePlacements.reduce(function (
        acc,
        placement
      ) {
      ...
      function effect(_ref) {
        ...
        var _options$scroll = options.scroll,
          scroll = void 0 === _options$scroll ? true : _options$scroll,
          _options$resize = options.resize,
          resize = void 0 === _options$resize ? true : _options$resize;
      ...
      function computeStyles(_ref5) {
        ...
        var _options$gpuAccelerat = options.gpuAcceleration,
          gpuAcceleration =
            void 0 === _options$gpuAccelerat ? true : _options$gpuAccelerat,
          _options$adaptive = options.adaptive,
          adaptive = void 0 === _options$adaptive ? true : _options$adaptive,
          _options$roundOffsets = options.roundOffsets,
          roundOffsets =
            void 0 === _options$roundOffsets ? true : _options$roundOffsets;
        if (false);
        var commonStyles = {
        ...
        if (null != state.modifiersData.arrow)
      ...
      function applyStyles(_ref) {
        ...
        Object.keys(state.elements).forEach(function (name) {
          ...
          Object.keys(attributes).forEach(function (name) {
            ...
            if (false === value) element.removeAttribute(name);
            else element.setAttribute(name, true === value ? "" : value);
          });
        });
      }
      ...
      function getDocumentRect(element) {
        ...
        if ("rtl" === getComputedStyle_getComputedStyle(body || html).direction)
      ...
      function detectOverflow(state, options) {
        ...
        var _options = options,
          ...
          boundary =
            void 0 === _options$boundary ? clippingParents : _options$boundary,
          _options$rootBoundary = _options.rootBoundary,
          rootBoundary =
            void 0 === _options$rootBoundary ? viewport : _options$rootBoundary,
          _options$elementConte = _options.elementContext,
          elementContext =
            void 0 === _options$elementConte ? popper : _options$elementConte,
          _options$altBoundary = _options.altBoundary,
          altBoundary =
            void 0 === _options$altBoundary ? false : _options$altBoundary,
      ...
      function flip(_ref) {
        ...
        var _options$mainAxis = options.mainAxis,
          checkMainAxis =
            void 0 === _options$mainAxis ? true : _options$mainAxis,
          _options$altAxis = options.altAxis,
          checkAltAxis = void 0 === _options$altAxis ? true : _options$altAxis,
          ...
          flipVariations =
            void 0 === _options$flipVariatio ? true : _options$flipVariatio,
      ...
      function preventOverflow(_ref) {
        ...
        var _options$mainAxis = options.mainAxis,
          checkMainAxis =
            void 0 === _options$mainAxis ? true : _options$mainAxis,
          _options$altAxis = options.altAxis,
          checkAltAxis = void 0 === _options$altAxis ? false : _options$altAxis,
          boundary = options.boundary,
          rootBoundary = options.rootBoundary,
          altBoundary = options.altBoundary,
          padding = options.padding,
          _options$tether = options.tether,
          tether = void 0 === _options$tether ? true : _options$tether,
      ...
      function isCursorOutsideInteractiveBorder(popperTreeData, event) {
        ...
        return popperTreeData.every(function (_ref) {
          ...
          var bottomDistance =
            "top" === basePlacement ? offsetData.bottom.y : 0;
      ...
      function getExtendedPassedProps(passedProps) {
        ...
        var pluginProps = plugins.reduce(function (acc, plugin) {
          ...
          if (name) {
            var _name;
            acc[name] =
              void 0 !== passedProps[name]
                ? passedProps[name]
                : null != (_name = defaultProps[name])
                ? _name
                : defaultValue;
          }
          return acc;
      ...
      function evaluateProps(reference, props) {
        ...
        out.aria = {
          expanded:
            "auto" === out.aria.expanded
              ? props.interactive
              : out.aria.expanded,
          content:
            "auto" === out.aria.content
              ? props.interactive
                ? null
                : "describedby"
              : out.aria.content,
      ...
      function createArrowElement(value) {
        var arrow = div();
        if (true === value) arrow.className = ARROW_CLASS;
        else {
      ...
      function setContent(content, props) {
        ...
        } else if ("function" !== typeof props.content)
      ...
      function render(instance) {
        ...
        function onUpdate(prevProps, nextProps) {
          ...
          if ("string" === typeof nextProps.animation)
          ...
          box.style.maxWidth =
            "number" === typeof nextProps.maxWidth
      ...
      function createTippy(reference, passedProps) {
        ...
        function getIsDefaultRenderFn() {
          ...
          return !!(
            null != (_instance$props$rende = instance.props.render) &&
        ...
        function getDelay(isShow) {
          if (
            ...
            (lastTriggerEvent && "focus" === lastTriggerEvent.type)
          )
            return 0;
        ...
        function onDocumentPress(event) {
          if (currentInput.isTouch)
            if (didTouchMove || "mousedown" === event.type) return;
          var actualTarget =
        ...
        function onTrigger(event) {
          ...
          var wasFocused =
            "focus" ===
            (null == (_lastTriggerEvent = lastTriggerEvent)
              ? void 0
              : _lastTriggerEvent.type);
          ...
          if (
            ...
            (instance.props.trigger.indexOf("mouseenter") < 0 ||
              isVisibleFromClick) &&
            false !== instance.props.hideOnClick &&
            instance.state.isVisible
          )
        ...
        function onMouseMove(event) {
          ...
          if ("mousemove" === event.type && isCursorOverReferenceOrPopper)
            return;
          var popperTreeData = getNestedPopperTree()
            ...
            .map(function (popper) {
              ...
              var state =
                null == (_instance$popperInsta = instance.popperInstance)
                  ? void 0
        ...
        function createPopperInstance() {
          ...
          modifiers.push.apply(
            modifiers,
            (null == popperOptions ? void 0 : popperOptions.modifiers) || []
          );
        ...
        function scheduleShow(event) {
          ...
          if (currentInput.isTouch && "hold" === touchValue && touchDelay)
            delay = touchDelay;
          if (delay)
        ...
        function show() {
          ...
          onFirstUpdate = function onFirstUpdate() {
            ...
            null == (_instance$popperInsta2 = instance.popperInstance)
              ? void 0
          ...
          observer.observe(target, {
            attributes:
              "undefined" === typeof options.attributes
                ...
                : options.attributes,
            childList:
              "undefined" === typeof options.childList
                ? true
                : options.childList,
            characterData:
      ...
      function updateSlides() {
        ...
        const shouldResetSlideSize =
          ...
          Object.keys(params.breakpoints).filter(
            (key) =>
              "undefined" !== typeof params.breakpoints[key].slidesPerView
          ).length > 0;
      ...
      function initProductSliders(breakpoints) {
      ...
      function initSliders() {
        if (document.querySelector(".tour-preview__slider"))
          new core(".tour-preview__slider", {
            modules: [Navigation],
            observer: true,
            observeParents: true,
            navigation: {
        ...
        if (document.querySelector(".tour-info__slider"))
          new core(".tour-info__slider", {
        ...
        if (document.querySelector(".tour-team__slider"))
          new core(".tour-team__slider", {
            modules: [Navigation],
            observer: true,
            observeParents: true,
            breakpoints: {
        ...
        if (document.querySelector(".tour-reviews__slider"))
          new core(".tour-reviews__slider", {
            modules: [Navigation],
            observer: true,
            observeParents: true,
            navigation: {
      ...
      document.initSliders = initSliders;
      document.initProductSliders = initProductSliders;
      ...
      // }));
      const currencyItem = document.querySelectorAll(
        ".filter-price__currency-item"
      );
      if (currencyItem)
        currencyItem.forEach((element) => {
          element.addEventListener("click", function (e) {
            ...
            if (!element.classList.contains("filter-price__currency-current"))
              element.classList.add("filter-price__currency-current");
            else element.classList.remove("filter-price__currency-current");
          });
        });
      window["FLS"] = true;
      isWebp();
